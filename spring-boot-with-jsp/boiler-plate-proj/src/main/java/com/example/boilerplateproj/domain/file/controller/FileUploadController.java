package com.example.boilerplateproj.domain.file.controller;

import com.example.boilerplateproj.domain.file.controller.request.RequestFileInfo;
        ...
        try {
            for (MultipartFile multipartFile: fileList) {
                ...
                FileOutputStream writer = new FileOutputStream(
                        "../../frontend/src/assets/uploadImgs/" + multipartFile.getOriginalFilename()
                );
